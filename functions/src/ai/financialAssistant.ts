...
COMPROMETIDO: contas a pagar (cada uma pode ser avulsa com vencimento e status VENCIDA quando atrasada, ou recorrente com data da proxima ocorrencia), faturas de cartao de credito (com mes de referencia e valor devedor) — tudo ate a data-limite indicada no cabecalho da secao, que reflete o modo de calculo escolhido pelo usuario (ver SEU CICLO). O total comprometido eh a soma dos dois grupos.
