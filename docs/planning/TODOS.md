...
- [ ] **Cofrinho: exclusão bloqueada e `byUser` no card não foram testados ao vivo** — exigiria depositar dinheiro real. Código e regra deployados; validados só por teste automatizado (107 de regras).
