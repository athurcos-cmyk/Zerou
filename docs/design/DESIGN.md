...
| `.pay-preview` (`global.css`, 2026-08-02) | Frase no topo de uma sheet de confirmação dizendo **o que vai acontecer**, com os valores reais ("Vamos lançar R$ 100 na fatura do Nubank"). Fundo `--info-soft`, não `--warning`: é orientação, nada deu errado. Usar sempre que o efeito de confirmar não for óbvio pelo rótulo do botão. |
