...
export const bankInstitutions: BankInstitution[] = [
  ...
  { id: 'itau', name: 'Itaú', aliases: ['itau', 'itaú', 'iti'], initials: 'It', suggestedType: 'checking' },
  { id: 'bradesco', name: 'Bradesco', aliases: ['next'], initials: 'Br', suggestedType: 'checking' },
  ...
  { id: 'santander', name: 'Santander', aliases: ['santander brasil'], initials: 'St', suggestedType: 'checking' },
  { id: 'inter', name: 'Inter', aliases: ['banco inter'], initials: 'In', suggestedType: 'digital_wallet' },
  { id: 'c6', name: 'C6 Bank', aliases: ['c6', 'c6bank'], initials: 'C6', suggestedType: 'digital_wallet' },
  { id: 'btg', name: 'BTG Pactual', aliases: ['btg', 'btg banking', 'btg investimentos'], initials: 'BT', suggestedType: 'investment' },
  { id: 'xp', name: 'XP', aliases: ['xp investimentos'], initials: 'XP', suggestedType: 'investment' },
  { id: 'picpay', name: 'PicPay', aliases: ['pic pay'], initials: 'PP', suggestedType: 'digital_wallet' },
  { id: 'mercado-pago', name: 'Mercado Pago', aliases: ['mercadopago', 'mercado livre'], initials: 'MP', suggestedType: 'digital_wallet' },
  { id: 'pagbank', name: 'PagBank', aliases: ['pagseguro', 'pag seguro'], initials: 'PB', suggestedType: 'digital_wallet' },
