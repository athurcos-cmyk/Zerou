...
export function JoinInvitePage() {
  ...
  if (!user) {
    ...
    return (
      <AuthLayout
        ...
        description="Crie uma conta ou entre na Granativa para organizar as finanças juntos. O convite fica salvo."
      >
        <div className="form-stack">
  ...
  return (
    <AuthLayout
      ...
      description="Alguém quer organizar as finanças juntos com você na Granativa."
    >
      <div className="form-stack">
